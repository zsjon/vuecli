...
<template>
  <div class="relative z-40 flex flex-col border-r border-gray-200 bg-white shadow-md transition-all duration-300">
    ...
    <div class="flex h-16 items-center w-full justify-end px-4 border-b border-gray-200 text-gray-600 hover:bg-gray-500 cursor-pointer">
        ...
        <Tabs v-model:value="activeTab">
            ...
            <TabPanels>
                <TabPanel value="0">
                    ...
                    <Button class="loginButton" @click="openLoginModal" label="로그인 Dialog 열어보기" severity="success"/>
                        ...
                        <AccordionPanel value="1"  class="flex items-center ">
                            ...
                            <AccordionContent>
                                ...
                                <div class="flex gap-4">
                                    <Card title="Card Test" class="border border-gray-300 rounded-xl shadow-none w-100 items-center">
                                        <template #title>1st Card Test</template>
                                        <template #content>
                                            <p class="m-0">PrimeVue Card 컴포넌트 테스트</p>
                                        </template>
                                    </Card>
                                    <Card title="Card Test 2" class="border border-gray-300 rounded-xl shadow-none w-100 items-center">
                                        <template #header>
                ...
                <TabPanel value="2" class="flex flex-col gap-15">
                    <!-- 3. Select, Checkbox, RadioButton -->
                     <div class="card flex flex-wrap justify-center gap-3">
                        ...
                        <Select v-model="value" optionLabel="label" dropdown :options="items"  placeholder="직급을 선택하세요." @change="onSelectChange" class="mt-4"/>
                     </div>
                    <div class="card flex flex-wrap justify-center gap-3">
                        <h2 class="text-center text-lg font-bold w-full">팀 선택</h2>
                        <div class="flex items-center gap-2">
                            <Checkbox v-model="work" inputId="work1" name="workType" value="UX-Lab"/>
                            <label for="work1">UX Lab</label>
                        </div>
                        <div class="flex items-center gap-2">
                            <Checkbox v-model="work" inputId="work2" name="workType" value="개발 1팀"/>
                            <label for="work2">개발 1팀</label>
                        </div>
                        <div class="flex items-center gap-2">
                            <Checkbox v-model="work" inputId="work3" name="workType" value="개발 2팀"/>
                            <label for="work3">개발 2팀</label>
                        </div>
                        <div class="flex items-center gap-2">
                            <Checkbox v-model="work" inputId="work4" name="workType" value="개발 3팀"/>
                    ...
                    <div class="flex flex-wrap justify-center gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            <RadioButton v-model="working" inputId="working1" name="tenureYn" value="퇴사" />
                            <label for="working1">퇴사</label>
                        </div>
                        <div class="flex items-center gap-2">
                            <RadioButton v-model="working" inputId="working2" name="tenureYn" value="재직" />
