<template>
    <div class="testDiv">
        <p class="p1" @click="clickP">서원정보 PMS로 이동
        ...
        <div class="testInput">
            <input type="text" v-model.number.trim="inputValue" placeholder="v-model 테스트" />
        ...
        <div class="">
            ...
            <label><input type="checkbox" value="김" v-model="checkboxValue"> 김</label>
            <label><input type="checkbox" value="이" v-model="checkboxValue"> 이</label>
            <label><input type="checkbox" value="박" v-model="checkboxValue"> 박</label>
